        ...
        switch (requestCode) {
            case "ACTION_ADD_RIG":
                ...
                rigViewModel = new DSTRig(DataManager.getHole(holeId).getLastClassPeopleCount(), date, startTime, endTime,
                        ...
                        Utility.formatDouble(DataManager.getHole(holeId).getLastAccumulatedMeterageLength()) + " m ~ " + Utility.formatDouble(DataManager.getHole(holeId).getLastAccumulatedMeterageLength() + 0.1) + " m",
