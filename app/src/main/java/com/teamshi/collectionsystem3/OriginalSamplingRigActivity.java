        ...
        switch (requestCode) {
            case "ACTION_ADD_RIG":
                ...
                rigViewModel = new OriginalSamplingRig(DataManager.getHole(holeId).getLastClassPeopleCount(), date, startTime, endTime,
                        ...
                        Utility.formatDouble(DataManager.getHole(holeId).getLastAccumulatedMeterageLength() + 0.1) + " m ~ " + Utility.formatDouble(DataManager.getHole(holeId).getLastAccumulatedMeterageLength() + 0.3) + " m",
